...
class NewCommentNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        $message = (new MailMessage())
            ...
            ->greeting(__('help-desk::notifications.comment_added.greeting'))
            ->line(__('help-desk::notifications.comment_added.body'))
            ->line(__('help-desk::notifications.comment_added.author', [
                'author' => $authorName,
            ]))
            ->action(__('help-desk::notifications.comment_added.action'), url('/'));
    ...
    protected function addThreadingHeaders(MailMessage $message): void
    {
        ...
        $messageId = sprintf('<%s-%s-%s@%s>', $this->ticket->uuid, 'comment', $this->comment->id, $domain);
